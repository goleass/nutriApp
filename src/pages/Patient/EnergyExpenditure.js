...
import EnergyExpenditureContent from '../../partials/patient/EnergyExpenditureContent';
import { useQuery } from 'react-query';
import { getInitialsName } from '../../utils/Utils';

function EnergyExpenditure(props) {
  const { id, energyExpenditureId } = useParams()
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="bg-white shadow-lg rounded-sm mb-8">
              <div className="flex flex-col md:flex-row md:-mr-px">
                <EnergyExpenditureContent id={id} energyExpenditure={patient.EnergyExpenditures.filter(a => a.id === energyExpenditureId)[0]} />
              </div>
            </div>
